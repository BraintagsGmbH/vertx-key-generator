...
<version>1.1.0_SNAPSHOT</version>
</dependency>
----
...
----
compile 'de.braintags:vertx-key-generator:1.1.0_SNAPSHOT'
----
...
----
@vertx
@vertx.event_bus().send(Java::DeBraintagsIoVertxKeygenerator::KeyGeneratorVerticle::SERVICE_NAME, keyContext) { |result_err,result|
  if (result_err != nil)
